  ...
  return (
    <div className="about-contacts">
      <div className='row'>
        ...
        <div className="about-contacts__countries">
          <div className='about-contacts__country'>
            ...
            <ul className='about-contacts__country-description country-description'>
              <li className=' country-description__item'>
                Miotech Impex LP
              </li>
              <li className=' country-description__item'>
        ...
        <Button icon={IconMail} className="about-contacts__support-btn" colorScheme='white'>support@minto.io</Button>
      </div>
    </div>
  )
}
